  ...
  return (
    <div>
      ...
      <div className="backplate scale-up-center">
        ...
        <p>ADVERTENCIA: La suguiente función habilitara o desabilitara todos los turnos en todas las canchas de su establecimiento. Procure tener cuidado ya que puede cancelar turnos ya otorgados.</p>
